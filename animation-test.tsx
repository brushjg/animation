import anime, { animate, createScope, spring, createDraggable } from 'animejs';
import { useEffect, useState, useRef } from 'react';
import './styles.scss'

//access this page from /animation on the server
    ...
    return (
        <div ref={root} className="animations">
            <div className="svg-wrapper" >
                 <svg xmlns="http://www.w3.org/2000/svg" className="logo js" preserveAspectRatio="xMidYMid meet" viewBox="0 0 630 630">
